...
<body onunload="unloadP('UniquePageNameHereScroll')" onload="loadP('UniquePageNameHereScroll')"> 
    ...
    <script src="system/resources/views/script/scrollfix.js" type="text/javascript"></script>
    <script type="text/javascript" src="system/resources/views/script/script.js"></script>       
